...
public class SocketClient implements Runnable{//"implements Runnable" to execute multithread
	...
	public static void main(String[] args) {
		...
		username = c.readLine("Enter your chat name : ");
		int character;
		try {
			//------------------------connect to server-------------------------			
			...
			Runnable runnable1 = new SocketClient(connection,username,otherusername,0);
			Runnable runnable2 = new SocketClient(connection,username,otherusername,1);
	...
	SocketClient(Socket connect,String str1,String str2,int i) {//constructor
